...
public class ViewSwitcher {
    ...
    public static void cargarVista(String fxmlFile) {
        try {
            FXMLLoader loader = new FXMLLoader(ViewSwitcher.class.getResource("/com/mycompany/presentacion/views/" + fxmlFile));
            loader.setControllerFactory(springContext::getBean); // Puente con Spring
